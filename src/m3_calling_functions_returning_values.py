...
def fancy_sums_of_digits(number):
    """
    ...
    if number > 0:
            x = sum_of_digits(number**1000)
            y = sum_of_digits(number**999)
            number = sum_of_digits(x**y)
            return number
